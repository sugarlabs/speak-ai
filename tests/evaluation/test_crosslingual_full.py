"""Generate full 18-sentence WAVs for Tier 2 languages."""
import json
import os
import soundfile as sf
from common import TIER_2, WAV_DIR, load_corpus
...
def main():
    ...
    for lang, info in TIER_2.items():
        ...
        for i, sent in enumerate(flat):
            ...
            try:
                for r in pipe(sent, voice="hf_alpha"):
                    if r.audio is None:
                        continue
    ...
    out_path = os.path.join(os.path.dirname(__file__), "crosslingual_full_report.json")
