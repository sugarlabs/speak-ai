...
def bad_word_list() -> list:
    with open(os.path.join(os.path.dirname(__file__), "profanity_blacklist.txt"), "r") as f: #the main reason why we have it encoded in b64 is so that even if a kid stumbles across this txt file by mistake they wont be able to understand anything
        a = f.readlines()
